 ...
 */
export async function getP1EventsByCategory(categoryName: string): Promise<P1EventDB[]> {
 ...
 */
export async function getP1EventsBySeries(seriesName: string): Promise<P1EventDB[]> {
 ...
 */
export async function getP1EventById(eventId: string): Promise<P1EventDB | null> {
