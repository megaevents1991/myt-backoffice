...
// convention). Validate against the Self-Service sandbox (NEXT_SECRET_AMADEUS_ENV=test)
// before flipping to the Enterprise host. Copy values from the Amadeus Enterprise
// workspace: https://developers.amadeus.com/my-enterprise-ws/rest
...
const CLIENT_ID = process.env.NEXT_SECRET_AMADEUS_CLIENT_ID as string;
const CLIENT_SECRET = process.env.NEXT_SECRET_AMADEUS_CLIENT_SECRET as string;
const OFFICE_ID = process.env.NEXT_SECRET_AMADEUS_OFFICE_ID; // optional
