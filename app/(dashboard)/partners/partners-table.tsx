...
import { getPartners, bulkDeletePartners, bulkDuplicatePartners } from "@/lib/actions/partner-actions"
...
export function PartnersTable() {
  ...
  const handleBulkDelete = async () => {
    ...
    try {
      ...
      setPartners(partners.filter((partner) => !selectedTrackingCodes.includes(partner.partner_tracking_code)))
  ...
  const handleBulkDuplicate = async () => {
    ...
    try {
      const duplicatedPartners = await bulkDuplicatePartners(selectedTrackingCodes)
    ...
    <div className="flex gap-2">
      <AlertDialog>
        <AlertDialogTrigger asChild>
          <Button variant="destructive" size="sm" disabled={isDeleting || selectedTrackingCodes.length === 0}>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will permanently delete {selectedTrackingCodes.length} partner(s). This action cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
