// app/(dashboard)/live-events/page.tsx
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Browse live sports and music events, performers, and ticket availability.
          </p>
        </div>
      </div>

      <Suspense fallback={<LiveEventsPageSkeleton />}>
        <LiveEventsContent />
      </Suspense>
    </div>
  );
...
function LiveEventsPageSkeleton() {
  return (
    <div className="space-y-6">
